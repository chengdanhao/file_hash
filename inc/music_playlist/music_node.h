...
#define add_album_music_to_delete_list(which_slot, prev_music_data_value, curr_music_data_value) _add_music(ALBUM_DELETE_LIST_PATH, which_slot, prev_music_data_value, curr_music_data_value)
#define add_album_music_to_download_list(which_slot, prev_music_data_value, curr_music_data_value) _add_music(ALBUM_DOWNLOAD_LIST_PATH, which_slot, prev_music_data_value, curr_music_data_value)
